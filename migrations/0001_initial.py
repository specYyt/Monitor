# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-25 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.CharField(choices=[('email', 'Email')], default='email', max_length=64, verbose_name='动作类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_sub_service', models.BooleanField(help_text='如果一个服务还有独立的子服务，比如，网卡服务有多个独立的子网卡', verbose_name='ServiceIndex')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('int', 'int'), ('float', 'float')], default='int', max_length=32, verbose_name='指标数据类型')),
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_calc_func', models.CharField(choices=[('avg', 'Average')], max_length=64, verbose_name='数据处理方式')),
        ...
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='想让哪些trigger触发', to='Monitor.Trigger'),
        ),
    ]
